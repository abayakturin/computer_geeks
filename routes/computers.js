...
router.get("/", function(req, res){
    ...
    Campground.find({}, function(err, allCampgrounds){
       if(err){
          ...
          res.render("computers/index",{campgrounds:allCampgrounds});
       }
    });
});
...
router.post("/", middleware.isLoggedIn, function(req, res){
    ...
    var newCampground = {name: name, price: price, image: image, description: desc, processor: processor,
...
router.get("/:id", function(req, res){
    ...
    Campground.findById(req.params.id).populate("comments").exec(function(err, foundCampground){
        if(err){
            ...
            res.render("computers/show", {campground: foundCampground});
        }
    });
});
...
router.get("/:id/edit", middleware.checkCampgroundOwnership, function(req, res){
    Campground.findById(req.params.id, function(err, foundCampground){
        res.render("computers/edit", {campground: foundCampground});
    });
});
